...
public final class PlayerWrapperManager<T> {
     ...
     */
    @NotNull public Optional<PlayerWrapper> getPlayerWrapper(@NotNull T player) {
     ...
     * @return an optional containing the player wrapper if it exists
     */
    @NotNull public Optional<PlayerWrapper> getPlayerWrapper(@NotNull UUID uuid) {
     ...
     */
    @Nullable public PlayerWrapper getPlayerWrapperOrNull(@NotNull UUID uuid) {
        Objects.requireNonNull(uuid, "UUID cannot be null");
     ...
     */
    @NotNull public Optional<StaffPlayerWrapper> getStaffPlayer(@NotNull UUID uuid) {
        Objects.requireNonNull(uuid, "UUID cannot be null");
    ...
    @Nullable public StaffPlayerWrapper getStaffPlayerOrNull(@NotNull UUID uuid) {
        Objects.requireNonNull(uuid, "UUID cannot be null");
        Optional<PlayerWrapper> optionalPlayerWrapper = getPlayerWrapper(uuid);
     ...
     */
    @NotNull public Optional<T> getPlayer(@NotNull PlayerWrapper playerWrapper) {
